    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.NALowRes)), "Probability of North American Low Density buildings appearing in Universal Zones." },
                
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.NARowRes)), "NA Row Housing Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.NARowRes)), "Probability of North American Row Housing buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.NAMedRes)), "NA Medium Density Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.NAMedRes)), "Probability of North American Medium Density buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.NAHighRes)), "NA High Density Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.NAHighRes)), "Probability of North American High Density buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.NAMixed)), "NA Mixed Housing Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.NAMixed)), "Probability of North American Mixed Housing buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EULowRes)), "EU Low Density Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EULowRes)), "Probability of European Low Density buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EURowRes)), "EU Row Housing Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EURowRes)), "Probability of European Row Housing buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EUMedRes)), "EU Medium Density Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EUMedRes)), "Probability of European Medium Density buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EUHighRes)), "EU High Density Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EUHighRes)), "Probability of European High Density buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EUMixed)), "EU Mixed Housing Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EUMixed)), "Probability of European Mixed Housing buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.NAComLow)), "NA Low Commercial Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.NAComLow)), "Probability of North American Low Commercial buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.NAComHigh)), "NA High Commercial Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.NAComHigh)), "Probability of North American High Commercial buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EUComLow)), "EU Low Commercial Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EUComLow)), "Probability of European Low Commercial buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EUComHigh)), "EU High Commercial Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EUComHigh)), "Probability of European High Commercial buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.Office)), "Office Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.Office)), "Probability of Office buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.Industrial)), "Industrial Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.Industrial)), "Probability of Industrial buildings appearing in Universal Zones." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.Other)), "Other / Region Packs Chance" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.Other)), "Probability of buildings from other Region Packs (e.g. China, France) appearing in Universal Zones." },
